...
describe('Button', () => {
  it('should render button', () => {
    ...
    customRender(<Button text="Submit" variant="default" onClick={onClickMock}></Button>)
  ...
  it('should not call on click when has empty fields and is disabled', () => {
    const onClickMock = jest.fn()
    customRender(<Button text="Submit" hasEmptyFields={true} variant="default" onClick={onClickMock}></Button>)
    const button = screen.getByTestId('button-id')
    button.click()
